...
if __name__ == '__main__':
    ...
    testname = 'r_tune_range_'+str(now.year-2023)+str(now.month)+str(now.day)+str(now.hour)+str(now.second)+ '_'  + GetFileNameOnly(n,d,k,range_,sigma)

    for range_ in [2,4,8,16,32,64]:#[512]:
        ...
        table.AddVariableToPrint('range',range_)
