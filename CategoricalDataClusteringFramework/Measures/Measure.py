...
class Measure(object):
    ...
    def __init__(self, datasetName):
        MeasureManager.CURRENT_DATASET = datasetName
    def calculate(self):
    ...
    def LoaddistMatrixAuto(self):
        if MeasureManager.IS_LOAD_AUTO == False or MeasureManager.CURRENT_DATASET=="None":
            print(colored( 'SKIP LOADING distMatrix because: ' + str(MeasureManager.IS_LOAD_AUTO) +" bd=" +MeasureManager.CURRENT_DATASET ),'yellow')
            return False
