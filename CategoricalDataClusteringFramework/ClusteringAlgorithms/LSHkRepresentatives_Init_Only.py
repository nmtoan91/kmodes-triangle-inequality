...
import TDef
from kRepresentatives import kRepresentatives
class LSHkRepresentatives_Init_Only(ClusteringAlgorithm):
    ...
    def DoCluster(self,n_group=2):
        ...
        self.name = "LSHkRepresentatives_Init_Only"
...
def Test_Simple():
    ...
    print("\n\n############## LSHkRepresentatives_Init_Only ###################")
    lshkrepresentatives = LSHkRepresentatives_Init_Only(DB['DB'],DB['labels_'] )
...
def Test(): 
    ...
    print("\n\n############## LSHkRepresentatives_Init_Only ###################")
    lshkrepresentatives = LSHkRepresentatives_Init_Only(DB['DB'],DB['labels_'] ,dbname=MeasureManager.CURRENT_DATASET ,k=TDef.k)
    lshkrepresentatives.SetupMeasure(MeasureManager.CURRENT_MEASURE)
    lshkrepresentatives.SetupLSH(measure=MeasureManager.CURRENT_MEASURE)
    lshkrepresentatives.DoCluster()
    lshkrepresentatives.CalcScore()
...
def TestDatasets(): 
    for dbname in MeasureManager.DATASET_LIST:
        ...
        MeasureManager.CURRENT_MEASURE = 'Overlap'
        print("\n\n############## LSHkRepresentatives_Init_Only ###################")
        alo = LSHkRepresentatives_Init_Only(DB['DB'],DB['labels_'],dbname=MeasureManager.CURRENT_DATASET )
