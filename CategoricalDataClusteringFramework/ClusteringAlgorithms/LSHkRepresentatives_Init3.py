...
class LSHkRepresentatives_Init3(ClusteringAlgorithm):
    ...
    def DoCluster(self,n_group=2,init_type ='random'):
        ...
        print("LSHkRepresentatives_Init3 n_group=" + str(n_group) + " Average neighbors:" + str(self.k/n_group) )
        for init_no in range(self.n_init):
            start_time_init = timeit.default_timer()
            if TDef.verbose >=1: print ('LSHkRepresentatives_Init3 Init ' + str(init_no))
            ...
            if TDef.verbose >=1: print ('LSHkRepresentatives_Init3 Init timelapse: ' + str(timeit.default_timer() -start_time_init))
...
def Test_Simple():
    ...
    print("\n\n############## LSHkRepresentatives_Init3 ###################")
    lshkrepresentatives = LSHkRepresentatives_Init3(DB['DB'],DB['labels_'] )
...
def Test(): 
    ...
    print("\n\n############## LSHkRepresentatives_Init3 ###################")
    lshkrepresentatives = LSHkRepresentatives_Init3(DB['DB'],DB['labels_'] ,dbname=MeasureManager.CURRENT_DATASET ,k=TDef.k)
    lshkrepresentatives.SetupMeasure(MeasureManager.CURRENT_MEASURE)
    lshkrepresentatives.SetupLSH(measure=MeasureManager.CURRENT_MEASURE)
...
def TestDatasets(): 
    for dbname in MeasureManager.DATASET_LIST:
        ...
        MeasureManager.CURRENT_MEASURE = 'Overlap'
        print("\n\n############## LSHkRepresentatives_Init3 ###################")
        alo = LSHkRepresentatives_Init3(DB['DB'],DB['labels_'],dbname=MeasureManager.CURRENT_DATASET )
