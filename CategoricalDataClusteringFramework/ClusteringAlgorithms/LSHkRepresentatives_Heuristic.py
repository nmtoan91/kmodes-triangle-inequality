#Note by toanstt: The short lists of near clusters are updated each itorator
...
class LSHkRepresentatives_Heuristic(ClusteringAlgorithm):
    ...
    def DoCluster(self,n_group=2,init_type ='random'):
        ...
        self.name = "LSHkRepresentatives_Heuristic"
...
def Test(): 
    ...
    print("\n\n############## LSHkRepresentatives_Heuristic ###################")
    lshkrepresentatives = LSHkRepresentatives_Heuristic(DB['DB'],DB['labels_'] ,dbname=MeasureManager.CURRENT_DATASET ,k=TDef.k)
...
def TestDatasets(): 
    for dbname in MeasureManager.DATASET_LIST:
        ...
        MeasureManager.CURRENT_MEASURE = 'Overlap'
        print("\n\n############## "+self.name+" ###################")
        alo = LSHkRepresentatives_Heuristic(DB['DB'],DB['labels_'],dbname=MeasureManager.CURRENT_DATASET )
